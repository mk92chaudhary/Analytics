...
plot(women, type='l')
plot(women, type='b', pch=18, lty=5, col=2, lwd=4)
plot(women, xlim=c(50,80), ylim=c(min(women$weight)-10, 200), pch=10)

#more features with plot
plot(x=women$weight, y=women$height, pch=15, xlab='Weight', ylab='Height', col='blue', cex=2, type='b')
