# simple linear regression , auto-collinearity(time series analysis data)
women
str(women)
...
# if p-value is >0.05, a model exists in the dataset and at least one of the x is related to y
summary(fit1)
...
#pvalue : 1.09e-14  < 0.05 : Model exists else no model and no relation exists
